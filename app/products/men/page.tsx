    ...
    <main className="products-page">
      <div className="page-hero">
        <div className="hero-content">
          <span className="section-label">MEN'S COLLECTION</span>
          <h1 className="page-title">Eyewear for <strong>Men</strong></h1>
          <p className="page-desc">
            Refined, bold, and built to last — discover frames crafted for the modern man.
          </p>
        </div>
        <div className="gender-tabs">
          <Link href="/products/men" className="gender-tab active">Men</Link>
      ...
      <div className="container">
        <div className="filter-bar">
          <div className="results-count">{menProducts.length} Products Found</div>
      ...
      <style jsx>{`
        ...
        .page-hero {
          background: linear-gradient(135deg, var(--color-primary, #1a1a2e) 0%, #0f172a 100%);
