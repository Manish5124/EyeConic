    ...
    <main className="products-page">
      <div className="page-hero">
        <div className="hero-content">
          <span className="section-label">KIDS' COLLECTION</span>
          <h1 className="page-title">Eyewear for <strong>Kids</strong></h1>
          <p className="page-desc">
            Fun, durable, and totally unbreakable — frames kids will actually love to wear.
          </p>
        </div>
        <div className="gender-tabs">
          <Link href="/products/men" className="gender-tab">Men</Link>
          <Link href="/products/women" className="gender-tab">Women</Link>
          <Link href="/products/kids" className="gender-tab active">Kids</Link>
      ...
      <div className="container">
        <div className="filter-bar">
          <div className="results-count">{kidsProducts.length} Products Found</div>
      ...
      <style jsx>{`
        ...
        .page-hero {
          background: linear-gradient(135deg, #0e4a2d 0%, #052e16 100%);
